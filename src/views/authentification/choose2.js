...
import '../../assets/css/choose2.css'; // Importer les styles pour Choose1
            ...
            <>
              ...
              <div className='col-lg-6 mt-5 mb-2'>
                <div className='yaourt '>
                  <h3 className='tibus'>Standard</h3>
                  <h1 className='tern'>49 fcfa <span className='ray'>per Month</span></h1>
