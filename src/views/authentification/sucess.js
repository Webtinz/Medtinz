...
const Success = () => {
  ...
  // const otherResponseDtatas = location.other; // Data sent from SignUp
console.log(hospital_admin_id);
  ...
  const handleContinue = (e) => {
    ...
    navigate('/subscription',  { state: hospital_admin_id }); // Redirige l'utilisateur vers la page Subscription
  };
