...
import Momologo from '../../../assets/images/MoMo_Logo_RGB_Horizontal-on_LIGHT_BG 1.png';
...
const PaymentPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/hospitaladmin/receiptpay', {
                    ...
                    <section className='pamentoption'>
                        <div className='selectpaymentoption'>
                            ...
                            <div className='momopayment'>
                                ...
                                />
                                <img src={Momologo} className='cardicon' alt="Consultation Icon" />
                            </div>
